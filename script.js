        ...
        window._rvShow = function (idx) {
            ...
            if (framesDiv && framesDiv.childElementCount === 0) {
                ...
                urls.forEach((url, j) => {
                    ...
                    framesHtml += `<iframe src="${url}" width="100%" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen webkitallowfullscreen mozallowfullscreen playsinline webkit-playsinline></iframe>`;
                });
