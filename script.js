...
// بيولد HTML للفيديو — لو Drive بيستخدم video tag مباشرة
function makeVideoEmbed(url) {
    ...
    if (fileId) {
        ...
        return `<video controls playsinline style="width:100%;border-radius:10px;margin-bottom:12px;display:block;background:#000;" preload="metadata">
            <source src="${directUrl}" type="video/mp4">
            <p style="color:#aaa;text-align:center;padding:1rem;">
                <a href="${directUrl}" target="_blank" style="color:#9b1d2a;">افتح الفيديو في تاب جديد</a>
            </p>
        </video>`;
    }
    // مش Drive — استخدم iframe عادي
