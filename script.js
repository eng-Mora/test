...
function toEmbedUrl(url) {
    ...
    if (fileId) return 'https://drive.google.com/file/d/' + fileId + '/preview?rm=minimal';
    return url;
}
        ...
        window._rvShow = function (idx) {
            ...
            if (framesDiv && framesDiv.childElementCount === 0) {
                ...
                urls.forEach((url, j) => {
                    ...
                    framesHtml += `<div style="position:relative;width:100%;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:10px;margin-bottom:12px;"><iframe src="${url}" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;border-radius:10px;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen webkitallowfullscreen mozallowfullscreen playsinline webkit-playsinline></iframe></div>`;
                });
